...
function init() {
  ...
  function gameOver() {
    ...
    if (player.y > height / 2 && flag === 0) {
      ...
      tweet.href =
        "http://twitter.com/share?url=http://is.gd/PnFFzu&text=I just scored " +
        score +
        " points in the Docker DevOps Jump game!&count=horiztonal&via=cssdeck&related=solitarydesigns";

      var facebook = document.getElementById("fbBtn");
      facebook.href =
        "http://facebook.com/sharer.php?s=100&p[url]=http://cssdeck.com/labs/html5-doodle-jump/8&p[title]=I just scored " +
        score +
        " points in the Docker DevOps Jump game!&p[summary]=Can you beat me in this awesome recreation of Doodle Jump created in HTML5?";
    }
  }
